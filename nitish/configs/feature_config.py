...
AI_CORE_SKILLS: FrozenSet[str] = frozenset({
    ...
    # LLMs & Language
    "NLP", "LLMs", "Fine-tuning LLMs", "Transformers", "Hugging Face",
    "LoRA", "Prompt Engineering", "LangChain", "OpenAI API", "RAG",
    ...
    # Infra / MLOps
    "MLOps", "Model Deployment", "ONNX", "DVC",
    "Weights & Biases", "BentoML",

    # Vector / Retrieval
    "Vector Databases", "Milvus", "Pinecone", "Weaviate", "FAISS",
